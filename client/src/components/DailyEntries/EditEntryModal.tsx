...
import { useUpdateDailyEntryMutation } from '../../redux/classApi';
...
export const EditEntryModal: React.FC<EditEntryModalProps> = ({
  ...
  const [updateDailyEntry, { isLoading, error }] = useUpdateDailyEntryMutation();
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Edit Daily Entry</h2>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              {/* Current Audio */}
              {entry.audioUrl && !audioFile && (
                <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
                  <p className="text-sm text-blue-700 mb-2">Current audio recording:</p>
                ...
                {audioFile && (
                  <div className="bg-gray-50 p-3 rounded-md">
                    <p className="text-sm text-gray-700">
                      <strong>New file:</strong> {audioFile.name}
                    </p>
          ...
          {error && (
            <div className="mt-4 bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-md text-sm">
              {(error as any)?.data?.message || 'Failed to update daily entry. Please try again.'}
            </div>
          )}
